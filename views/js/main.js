...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    // Changed querySelectorAll to getElementsByClassName to reduce number of targeted elements
...
// Moved this variable out of the loop as it's result does not rely on "i"
...
function updatePositions() {
  ...
  // Removed querySelectorAll() to use getElementsByClassName instead to reduce number of elements targeted
  var items = document.getElementsByClassName('mover');
  // Stored document call in variable to avoid being used in the loop
  var pizzaCanvas = document.body.scrollTop;
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin((pizzaCanvas / 1250) + (i % 5));
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  //Removed elem definition outside loop
